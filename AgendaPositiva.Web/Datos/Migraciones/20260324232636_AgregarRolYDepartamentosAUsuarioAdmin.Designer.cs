...
namespace AgendaPositiva.Web.Datos.Migraciones
{
    ...
    [Migration("20260324232636_AgregarRolYDepartamentosAUsuarioAdmin")]
    partial class AgregarRolYDepartamentosAUsuarioAdmin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgendaPositiva.Web.Features.Admin.Auth.Domain.UsuarioAdministrador", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("Departamentos")
                        .IsRequired()
                        .HasColumnType("jsonb");
